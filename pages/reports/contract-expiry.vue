<template>
  <div class="container max-w-6xl mx-auto py-6 px-4 sm:px-6">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
      <h1 class="text-2xl font-bold">Contract Expiry Timeline</h1>
    ...
    <div class="mb-6">
      <UFormGroup label="View Period" :help="periodHelp">
    ...
    <ContractExpiryReport :period="reportPeriod" :key="reportKey" />
  </div>
</template>

<script setup lang="ts">
import { ref, computed, onMounted } from 'vue';
import ContractExpiryReport from '~/components/reports/templates/ContractExpiryReport.vue';
...
// Helper text
const periodHelp = 'Select the number of months to include in the report';
